...
BLOG_TITLE = "Highly Unlikely Case Studies"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://blog.blaisepabon.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://blog.blaisepabon.com/"
BLOG_EMAIL = "blaise@highly-unlikely.com"
BLOG_DESCRIPTION = "A blog of unusual cases"  # (translatable)
...
# slim-bookworm# If you want to use ISO 8601 (also valid RFC 3339) throughout Nikola
